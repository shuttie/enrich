...
class TransformSpec extends Specification {
    "transform should not drop properties with explicit null values" >> {
      ...
      val raw = RawEvent(
        ...
        Map("tv" -> "0", "p" -> "web", "e" -> "pv", "nuid" -> "123", "cx" -> "").toOpt,
